...
impl fmt::Display for LightningSwapError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            LightningSwapError::InvalidSwapResponse(msg) => write!(f, "Invalid swap response: {}", msg),
            LightningSwapError::SwapTimeout(msg) => write!(f, "Swap timeout: {}", msg),
            LightningSwapError::InvoiceDecodeError(msg) => write!(f, "Invoice decode error: {}", msg),
